export class ObjectInfo {
  ...
  constructor(reader: any, version: number, unityRevision: string, targetPlatform: number, assetFile?: AssetFile | null);
  getClassName(): string;
...
export class AssetManager {
  ...
  processTextureRect(rect: { x: number; y: number; width: number; height: number }, height: number, invertY?: boolean): { x: number; y: number; width: number; height: number };
...
declare module 'unityfs-js/exporters/index.js' {
  ...
  export function processMesh(
    objectInfo: ObjectInfo,
    options?: any
  ): Promise<{ data: { raw: string | ArrayBuffer } }>;
